...
const $$Request = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="request-section" data-astro-cid-dlxxshph> <div class="invitation-text" data-astro-cid-dlxxshph> <h2 data-astro-cid-dlxxshph>¡Obtén tu presupuesto personalizado!</h2> <span class="bouncing-element" data-astro-cid-dlxxshph>🤝🏻</span> <p data-astro-cid-dlxxshph>
¿Estás interesado en construir una alberca perfecta para tu hogar? 
        Nuestro equipo está listo para ayudarte a hacer realidad tu proyecto. 
        Completa el formulario a continuación para recibir un presupuesto detallado y sin compromiso.
</p> <p data-astro-cid-dlxxshph>
¡Contáctanos hoy mismo y da el primer paso hacia tu nueva alberca!
</p> </div> </section> `;
}, "C:/Users/Usuario/OneDrive/Documentos/GitHub/ConstruccionesGomez/shining-star/src/components/request.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Construcciones G\xF3mez" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "Main", $$Main, { "id": "home" })} ${renderComponent($$result2, "MyJob", $$MyJob, { "id": "gallery" })} ${renderComponent($$result2, "Need", $$Need, {})} ${renderComponent($$result2, "Request", $$Request, {})} ${renderComponent($$result2, "ContactMe", $$ContactMe, { "id": "contact" })} </main> ` })}`;
